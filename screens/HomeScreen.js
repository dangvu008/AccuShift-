...
const HomeScreen = ({ navigation }) => {
  ...
  const { weatherAlerts, checkWeatherAlertsForShift, weatherSettings, isLoading: weatherIsLoading } = useWeather()
  ...
  useEffect(() => {
    if (currentShift && currentShift.showSignButton && workStatus === "checked_in") {
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        <View style={[styles.actionButtonContainer, { backgroundColor: theme.colors.card }]}>
          ...
          {actionHistory.length > 0 && <ActionHistoryTimeline actions={actionHistory} />}
        </View>
